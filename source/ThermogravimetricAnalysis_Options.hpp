...
namespace OpenSMOKE
{
	class Grammar_ThermogravimetricAnalysis_Options : public OpenSMOKE::OpenSMOKE_DictionaryGrammar
	{
	protected:
	...
	ThermogravimetricAnalysis_Options::ThermogravimetricAnalysis_Options()
	{
	...
	void ThermogravimetricAnalysis_Options::SetupFromDictionary(OpenSMOKE::OpenSMOKE_Dictionary& dictionary)
	{
		Grammar_ThermogravimetricAnalysis_Options grammar;
