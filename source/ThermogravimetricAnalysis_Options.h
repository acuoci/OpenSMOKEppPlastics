...
#ifndef OpenSMOKE_ThermogravimetricAnalysis_Options_H
#define	OpenSMOKE_ThermogravimetricAnalysis_Options_H
...
namespace OpenSMOKE
{
	class ThermogravimetricAnalysis_Options
	{
	public:
		...
		*/
		ThermogravimetricAnalysis_Options();
...
#include "ThermogravimetricAnalysis_Options.hpp"

#endif	/* OpenSMOKE_ThermogravimetricAnalysis_Options_H */
