...
namespace OpenSMOKE
{
	...
	class Grammar_Polypropylene_Kinetics : public OpenSMOKE::OpenSMOKE_DictionaryGrammar
	{
	protected:
		...
		virtual void DefineRules()
		{
			...
			AddKeyWord(OpenSMOKE::OpenSMOKE_DictionaryKeyWord("@Es",
				OpenSMOKE::SINGLE_MEASURE,
				"Random scission (PE -> Rp + Rsb): activation energy (default: 73000. cal/mol)",
				false));
			...
			AddKeyWord(OpenSMOKE::OpenSMOKE_DictionaryKeyWord("@Ea",
				OpenSMOKE::SINGLE_MEASURE,
				"Allylic scission (PE -> Ra + Rsb): activation energy (default: 65000. cal/mol)",
				false));
			...
			AddKeyWord(OpenSMOKE::OpenSMOKE_DictionaryKeyWord("@Eaf",
				OpenSMOKE::SINGLE_MEASURE,
				"H-abstraction reaction (TODO): activation energy (default: 11000. cal/mol)",
				false));
			...
			AddKeyWord(OpenSMOKE::OpenSMOKE_DictionaryKeyWord("@Abb14",
				OpenSMOKE::SINGLE_MEASURE,
				"Back-biting reaction (isomerization 1,4): TODO: frequency factor (default: 1.00e10 mol,l,s)",
				false));
			...
			AddKeyWord(OpenSMOKE::OpenSMOKE_DictionaryKeyWord("@Abb15",
				OpenSMOKE::SINGLE_MEASURE,
				"Back-biting reaction (isomerization 1,5): TODO: frequency factor (default: 1.60e9 mol,l,s)",
				false));
			...
			AddKeyWord(OpenSMOKE::OpenSMOKE_DictionaryKeyWord("@Abb16",
				OpenSMOKE::SINGLE_MEASURE,
				"Back-biting reaction (isomerization 1,6): TODO: frequency factor (default: 5.00e8 mol,l,s)",
				false));
		...
		opensmokepp::plastics::PolypropyleneKinetics& kinetics)
	{
		...
		OpenSMOKE::Grammar_Polypropylene_Kinetics grammar_kinetics;
