...
#ifndef Grammar_ExplicitOdeSolver_Parameters_H
#define	Grammar_ExplicitOdeSolver_Parameters_H
...
namespace OdeSMOKE
{
	class Grammar_ExplicitOdeSolver_Parameters : public OpenSMOKE::OpenSMOKE_DictionaryGrammar
	{
	protected:
...
#endif	/* Grammar_ExplicitOdeSolver_Parameters_H */
